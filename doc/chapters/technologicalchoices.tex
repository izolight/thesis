...
\subsection{Performance Comparison of In-Browser Hashing Options}
...
we measure the time it takes for the browser to calculate the checksum of 1GB of random data.
