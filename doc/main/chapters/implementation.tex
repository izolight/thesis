...
For a graphical representation\footnote{Graphic courtesy of traefik documentation. Source: https://docs.traefik.io/assets/img/traefik-architecture.png} on what \texttt{traefik} does, please see figure~\ref{fig:traefik}.
...
\begin{figure}
    \begin{center}
        %        \includegraphics[width=0.9\linewidth]{images/traefik-architecture.png}
        \includegraphics[scale=0.5]{images/traefik-architecture.png}
        \caption{Traefik Architecture}
        \label{fig:traefik}
    \end{center}
\end{figure}
