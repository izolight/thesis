...
This is why we decided to compare the performance of each implementation in a simple test:
...
So, in the end, unfortunately we couldn't find any free-of-charge \gls{IDP} that we could use.
