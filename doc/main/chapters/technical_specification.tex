...
Since the verifier is in possession of the documents, they can calculate their respective hashes,
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
        \captionof{table}{Endpoints offered by the Signing Service}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Output in case of invalid input}
\end{figure}

Sample Error Response:
\lstinputlisting[caption={Error response}, captionpos=b, language=JavaScript, label={lst:errorresponse}]{listings/error_response.txt}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Input to the login endpoint}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
        \captionof{table}{Output of the login endpoint}
    \end{center}
\end{figure}

Sample Request:

\lstinputlisting[caption={login request}, captionpos=b, language=JavaScript, label={lst:hashesrequest}]{listings/hashes_request.txt}

Sample Response:

\lstinputlisting[caption={login response}, captionpos=b, language=JavaScript, label={lst:hashesresponse}]{listings/signing_request.txt}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Input to the signing endpoint}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Output of the signing endpoint}
\end{figure}

Sample Request:
\lstinputlisting[caption={Sign request}, captionpos=b, language=JavaScript, label={lst:signrequestexample}]{listings/sign_request_example.txt}

Sample Response:

\lstinputlisting[caption={sign response}, captionpos=b, language=JavaScript, label={lst:signresponse}]{listings/sign_response.txt}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Input to the signature retrieval endpoint}
\end{figure}
...
\lstinputlisting[caption={signature request}, captionpos=b, language=JavaScript, label={lst:signaturerequest}]{listings/signature_request.txt}

Sample Response:

\lstinputlisting[caption={signature response}, captionpos=b, language=JavaScript, label={lst:signatureresponse}]{listings/signature_response.txt}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Overview of endpoints offered by the verification service}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Input to the signature verification endpoint}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \captionof{table}{Output of the signature verification endpoint}
\end{figure}

Sample Request:
\lstinputlisting[caption={sign request}, captionpos=b, language=JavaScript, label={lst:verifyrequest}]{listings/verification_request.txt}
...
\lstinputlisting[caption={sign response}, captionpos=b, language=JavaScript, label={lst:verifyresponsefailed}]{listings/verification_failed.txt}
...
\lstinputlisting[caption={SignatureData schema}, captionpos=b, label={lst:signaturedataschema}]{listings/signaturedata.proto}
...
\lstinputlisting[caption={SignatureFile message}, captionpos=b, label={lst:signaturefileschema}]{listings/signaturefile.proto}
