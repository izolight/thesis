...
\begin{itemize}
	\item \gls{HMAC} of the document
	\item list of the \gls{HMACs} of all other documents that were signed together (needed for link between ID token and signature)
	\item used hashing algorithm
	\item key for the \gls{HMAC}
